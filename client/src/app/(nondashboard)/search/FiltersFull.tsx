      ...
      <div className="flex flex-col space-y-6">
        ...
        <div>
          ...
          <div className="flex items-center">
            ...
            <Button
              ...
              className="rounded-r-xl rounded-l-none border-l-none border-black shadow-none border hover:bg-orange-700 hover:text-orange-50"
            >
        ...
        <div className="flex gap-4 mt-6">
          <Button
            ...
            className="flex-1 bg-orange-700 text-white rounded-xl"
          >
            APPLY
          </Button>
          <Button
