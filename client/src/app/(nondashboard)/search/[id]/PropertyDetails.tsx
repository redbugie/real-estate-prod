  ...
  return (
    <div className="mb-6">
      ...
      <div className="mt-12 mb-16">
        <h3 className="text-xl font-semibold text-orange-800 dark:text-orange-100">
          Highlights
        </h3>
          ...
          {property.highlights.map((highlight: HighlightEnum) => {
            ...
            return (
              <div
                ...
                className="flex flex-col items-center border rounded-xl py-8 px-4"
              >
                <Icon className="w-8 h-8 mb-2 text-orange-600 dark:text-orange-300" />
                <span className="text-sm text-center text-orange-600 dark:text-orange-300">
      ...
      {/* Tabs Section */}
      <div>
        <h3 className="text-xl font-semibold text-orange-800 dark:text-orange-100 mb-5">
          Fees and Policies
        </h3>
